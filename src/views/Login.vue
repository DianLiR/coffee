<template>
  <div class="login">
    <van-nav-bar left-text="返回" right-text="取消" @click-right="goState">
      <template #left>
        <div class="nav-left">
          <div class="logo"></div>
      ...
      <van-form>
        ...
        <div class="commit-btn">
          <van-button
            round
            block
            color="linear-gradient(to right, #fbc2eb 0%, #a6c1ee 100%)"
            @click="login"
          >
            登录
          </van-button>
        ...
        <div class="commit-btn">
          <van-button round block type="default" @click="toggleRegistered">
            注册
          </van-button>
        </div>
      </van-form>
